...
from agent.services.speech_to_text.eleven_labs.service import transcribe_audio, synthesize_speech
                ...
                if data["event"] == "media":
                    ...
                    if len(self.audio_buffer) > 40000:  # arbitrary threshold for full utterance
                        ...
                        if len(self.transcript_text) != 0:
                            ...
                            logger.warning("audio_consumer_receive", message="Empty transcript")
                else:
