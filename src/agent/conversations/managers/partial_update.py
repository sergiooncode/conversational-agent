...
class ConversationPartialUpdateManager:
    ...
    async def _update_raw_conversation(
        ...
        previous_raw_conversation_updated.append(f"User: {self.context['message']}")
        previous_raw_conversation_updated.append(f"Assistant: {result.final_output}")
        conversation_to_update.raw_conversation = previous_raw_conversation_updated
